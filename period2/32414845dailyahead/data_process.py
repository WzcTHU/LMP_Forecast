...
def process_hrl_load_prelim(file_name):
    df = pd.read_csv(file_name)
...
if __name__ == '__main__':
    ...
    process_load_frcstd_hist('load_frcstd_hist_ATSI_20171001_20181101.csv')
    process_hrl_load_prelim('hrl_load_prelim_ATSI_20171001_20181101.csv')
    process_lmp('node32414845_lmp_20171001_20181101.csv')
