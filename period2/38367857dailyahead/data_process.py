...
if __name__ == '__main__':
    ...
    # process_load_frcstd_hist('load_frcstd_hist_DAY_20171001_20181101.csv')
    # process_hrl_load_prelim('hrl_load_prelim_DAY_20171001_20181101.csv')
    process_lmp('node38367857_lmp_20171001_20181101.csv')
